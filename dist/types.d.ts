...
type LaravelResponse<S = unknown, E = unknown> = LaravelSuccess<S> | LaravelError<E> | undefined;
...
interface LaravelProps<T, E> {
    ...
    toastError?: string | ((err: AxiosError<LaravelError<E>> | undefined) => string | ReactNode);
...
export { type LaravelResponse, type LaravelSuccess, type LaravelError, type LaravelObject, type LaravelPagination, type LaravelProps, type LaravelDisplay, };
